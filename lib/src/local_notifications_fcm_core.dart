...
import 'package:local_push_notifications_fcm/local_notifications_fcm.dart';
import 'package:local_push_notifications_fcm/src/fcm_definitions.dart';
import 'package:local_push_notifications_fcm/src/isolates/silent_push_isolate_main.dart';

import 'exceptions/exceptions.dart';

class LocalNotificationsFcm {
  ...
  factory LocalNotificationsFcm() => _instance;

  @visibleForTesting
  LocalNotificationsFcm.private(MethodChannel channel) : _channel = channel;

  static final LocalNotificationsFcm _instance =
      LocalNotificationsFcm.private(
      ...
      case CHANNEL_METHOD_SILENT_CALLBACK:
        try {
          if (!await receiveSilentData(
            ...
            throw LocalNotificationsFcmException(
          ...
          print(
              "Local Notifications FCM: An error occurred in your silent data handler:");
          print(e);
        }
        return;
