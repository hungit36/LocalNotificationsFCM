...
import 'package:local_push_notifications_fcm/src/exceptions/exceptions.dart';
...
Future<void> channelMethodSilentCallbackHandle(MethodCall call) async {
  try {
    ...
    print(
        "Local Notifications FCM: An error occurred in your background messaging handler:");
    print(e);
  }
}
